// Pre-run JSON validator for tasks-batch-9.sql FAQs
// S118 lesson: PostgreSQL JSON parse errors give char-offset only, not line numbers.
// This script splits the SQL by FAQ JSON literal lines and JSON.parse each one.
...
const sqlPath = path.join(__dirname, '..', 'tasks-batch-9.sql')
