  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-5 py-10 md:py-14">
        ...
        {isAutoGenerated && (
          <div className="mb-6 p-4 rounded-xl border border-amber-200 dark:border-amber-900/40 bg-amber-50/60 dark:bg-amber-950/20 flex items-start gap-3">
            <span className="text-[18px] flex-shrink-0" aria-hidden="true">⚡</span>
            <div>
              <p className="text-[13px] font-bold text-amber-900 dark:text-amber-200 mb-1">
                Auto-generated comparison
              </p>
              <p className="text-[12px] text-amber-900/80 dark:text-amber-200/80 leading-relaxed">
                This pair has not been editorially reviewed yet. Scores below are derived from data signals (rating, pricing, free tier, integrations, adoption) on each tool page. Editorial review is queued. <Link href="/methodology" className="underline font-semibold">How we rank</Link>.
              </p>
            </div>
          </div>
        )}
